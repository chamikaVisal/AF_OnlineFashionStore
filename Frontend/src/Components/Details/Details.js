...
class ConnectedDetails extends Component {
    ...
    async onSubmitCommentClicked() {
        ...
        axios.post(
            'http://localhost:8080/user/addComment',
            {
    ...
    async fetchProductDetail() {
        ...
        axios.get(
            'http://localhost:8080/open/getproduct?prod_Id=' + this.props.location.state.id,
            {
                headers: {
                    'Content-Type': 'application/json',
    ...
    addProductToWishlist() {
        ...
        axios.post(
            ...
            .then((response) => {
                ...
                console.log(err);
                alert("Error occured whille adding")
            });
    }
    ...
    render() {
        ...
        return (
            <div style={{ padding: 10, marginRight: 20, marginLeft: 30, marginTop: 20, borderRadius: 20, border: '2px solid gray' }}>
                <div
                    style={{
                        marginBottom: 20,
                        marginTop: 10,
                ...
                >
                    <div style={{ fontWeight: 'bold ' }}>{this.state.item.prodName}</div>
                ...
                <div style={{ display: "flex" }}>
                    ...
                    <div
                        style={{
                            ...
                            marginLeft: 20,
                            display: "flex",
                            flexDirection: "column", padding: 10, borderRadius: 10, border: '1px solid black', backgroundColor: '#f0f0f0'
                    ...
                    >
                        <div style={{
                            ...
                            <div>ID: </div>
                            <div style={{ marginLeft: 60 }}>{this.state.item.prod_id} </div>
                        </div>
                        <div style={{
                            fontSize: 16,
                            display: "flex",
                            ...
                            <div>Price: </div>
                            <div style={{ marginLeft: 40, fontSize: 25, fontWeight: 'bold' }}>{this.state.item.prodPrice} $ </div>
                        ...
                        <div style={{
                            ...
                            <div> Rating:</div>
                            <div style={{ marginLeft: 30 }}>{this.state.item.averageRating} </div>
                        ...
                        <div style={{
                            ...
                            <div>Discount:</div>
                            <div style={{ marginLeft: 15 }}>{!!(this.state.item.prodDiscount) ? this.state.item.prodDiscount.discountValue : 0} % </div>
                        </div>
            ...
            */}
                        ...
                        >
                            ...
                            <Button
                                style={{ width: 170, marginTop: 20, marginBottom: 10, marginRight: 5, backgroundColor: '#006efc' }}
                                color='red'
                                variant="outlined"
                                onClick={() => {
                                    alert(this.state.quantity + " products added to the cart !")
                                    this.props.dispatch(
                                        addItemInCart({
                                            ...this.state.item,
                            ...
                            >
                                ...
                                <AddShoppingCartIcon style={{ marginLeft: 5, color: 'white' }} />
                            </Button>

                            <Button
                                style={{ width: 200, marginTop: 20, marginBottom: 10, backgroundColor: '#ffffff' }}
                                color="primary"
                                variant="outlined"
                                onClick={() => {
                ...
                >
                    <div style={{ color: 'gray' }}>Comments</div>
        ...
        */}
                ...
                >
                    ...
                    <Button
                        ...
                        style={{ height: 30, width: 180, marginTop: 0, marginRight: 30, backgroundColor: '#006efc' }}
                        color="primary"
                        variant="outlined"
                        onClick={() => {
                    ...
                    >
                        <div style={{ color: 'white' }}> submit comment</div>
                    </Button>
                </div>
