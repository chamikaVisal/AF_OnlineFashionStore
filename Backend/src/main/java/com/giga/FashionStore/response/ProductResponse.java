...
public class ProductResponse {
    ...
    public ProductResponse(String prod_id, String prodName, String prodDescription, String prodPrice, String prodDiscountedPrice, List<Comment> prodComments, double averageRating, Discount prodDiscount) {
